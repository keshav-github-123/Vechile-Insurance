...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.proj1_estimator = Proj1Estimator(bucket_name=model_pusher_config.bucket_name,
                                ...
                                preprocessor_path=model_pusher_config.s3_preprocessor_key_path)
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            ...
            self.proj1_estimator.save_model(from_file=self.model_evaluation_artifact.trained_model_path, ml_model=True)
            self.proj1_estimator.save_model(from_file=self.data_transformation_artifact.transformed_object_file_path, preprocessor_model=True)
